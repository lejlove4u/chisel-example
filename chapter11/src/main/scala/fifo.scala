...
class BubbleFifo1[T <: Data](gen: T, depth: Int) extends Fifo(gen: T, depth: Int) {
...
object FifoUse extends App {
    val dataBitWidth = 8
    val depthWidth = 4

    emitVerilog(new BubbleFifo1(UInt(dataBitWidth.W), depthWidth), Array("--target-dir", "generated"))
    emitVerilog(new DoubleBufferFifo(UInt(dataBitWidth.W), depthWidth), Array("--target-dir", "generated"))
    emitVerilog(new RegFifo(UInt(dataBitWidth.W), depthWidth), Array("--target-dir", "generated"))
    emitVerilog(new MemFifo(UInt(dataBitWidth.W), depthWidth), Array("--target-dir", "generated"))
    emitVerilog(new CombFifo(UInt(dataBitWidth.W), depthWidth), Array("--target-dir", "generated"))
}